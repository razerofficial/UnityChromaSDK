# RazerSDKDelete - the C# library for the Razer REST API
...
```
nuget pack -Build -OutputDirectory out RazerSDKDelete.csproj
```
...
------------ | ------------- | ------------- | -------------
*RazerDeleteApi* | [**DeleteChromaSdk**](docs/RazerDeleteApi.md#deletechromasdk) | **DELETE** / | 


<a name="documentation-for-models"></a>
## Documentation for Models

 - [RazerDeletePackage.Model.DeleteChromaSdkResponse](docs/DeleteChromaSdkResponse.md)
