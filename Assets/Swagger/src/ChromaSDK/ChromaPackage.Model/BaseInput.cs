...
namespace ChromaSDK.ChromaPackage.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaseInput :  IEquatable<BaseInput>
    {
        /// <summary>
        ...
        public BaseInput(string Title = default(string), string Description = default(string), BaseInputAuthor Author = default(BaseInputAuthor), List<string> DeviceSupported = default(List<string>), string Category = default(string))
        {
            this.Title = Title;
        ...
        public BaseInputAuthor Author { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BaseInput);
        }

        /// <summary>
        /// Returns true if BaseInput instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseInput to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseInput other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
